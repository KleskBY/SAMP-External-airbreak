...
void ImGui::NewFrame()
{
    ...
    if (g.SettingsDirtyTimer > 0.0f)
    {
        ...
        if (g.SettingsDirtyTimer <= 0.0f)
        {
            ...
            else g.IO.WantSaveIniSettings = true;  // Let user know they can call SaveIniSettingsToMemory(). user will need to clear io.WantSaveIniSettings themselves.
    ...
    //Begin("Debug##Default", (bool*)0, ImGuiWindowFlags_NoSavedSettings);
